...
import eventsBg from "../../../assets/images/our-history.png";
...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      {/* Left side content only - using grid with explicit left column */}
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-6 pt-8 lg:pt-12">
              ...
              >
                For over three decades, Royal Rays has been at the forefront of
                the diamond industry, crafting timeless pieces that embody
                excellence, precision, and unparalleled beauty.
              </motion.p>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full border border-white/15 flex items-center justify-center">
                    <FaHistory className="text-white/40 text-xs" />
                  </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full border border-white/15 flex items-center justify-center">
                    <FaAward className="text-white/40 text-xs" />
                  </div>
                  <span className="text-white/40 text-xs font-light tracking-wider">
                    AWARD WINNING
                  </span>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full border border-white/15 flex items-center justify-center">
                    <FaDiamond className="text-white/40 text-xs" />
                  </div>
                  <span className="text-white/40 text-xs font-light tracking-wider">
                    GLOBAL PRESENCE
                  </span>
