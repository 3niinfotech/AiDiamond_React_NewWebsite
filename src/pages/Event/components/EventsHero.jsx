...
import { FaGlobe, FaUsers, FaArrowRight, FaGem } from "react-icons/fa";
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-6 pt-8 lg:pt-12">
              ...
              >
                Global expos to exclusive showcases worldwide. Experience the
                finest diamond craftsmanship and connect with industry leaders
                at our premier events across four continents.
              </motion.p>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full border border-white/15 flex items-center justify-center">
                    <FaGlobe className="text-white/40 text-xs" />
                  </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full border border-white/15 flex items-center justify-center">
                    <FaGem className="text-white/40 text-xs" />
                  </div>
                  <span className="text-white/40 text-xs font-light tracking-wider">
                    500+ EXHIBITORS
                  </span>
