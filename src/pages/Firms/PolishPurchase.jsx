...
const config = VOUCHER_CONFIGS["polish-purchase"];
...
const PolishPurchase = () => {
  ...
  // Filter vouchers for Polish Purchase
              ...
              <table className="w-full text-left text-xs border-collapse">
                ...
                <tbody className="divide-y divide-[#EAEAEA]">
                  {filteredEntries.length === 0 ? (
                    <tr>
                      <td colSpan={22} className="py-12 text-center text-[#777777]">
                        <IconComponent
