...
const config = VOUCHER_CONFIGS["lgd-purchase"];
...
const LgdPurchase = () => {
  ...
  // Filter vouchers for LGD Purchase
  ...
  const handleOpenEdit = (v) => {
    setEditingVoucher(v);
    const existingParty = allAvailableParties.find(
  ...
  const handleFormSubmit = (e) => {
    ...
    if (editingVoucher) {
      ...
      const updated = allVouchers.map((item) =>
        item.id === editingVoucher.id ? updatedVoucher : item
      );
      saveVouchersToStorage(updated);
